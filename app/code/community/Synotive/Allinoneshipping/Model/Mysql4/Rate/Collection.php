...
*/
class Synotive_Allinoneshipping_Model_Mysql4_Rate_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function addAddressFilters($request)
    {
        ...
        if (Mage::getStoreConfig('carriers/synotiveallinoneshipping/numeric_zip'))
        {
